...
public class DataTransformerTest {
  ...
  public void testAllFilesExistAndModifiedInOutput() throws Exception {
    ...
    try {
      inputFileObjects =
          DataTransformer.s3ClientForStudentBuckets.listObjects(DataTransformer.INPUT_BUCKET_NAME);
      ...
      do {
        for (S3ObjectSummary objectSummary : inputFileObjects.getObjectSummaries()) {
          ...
          s3OutputObject =
              DataTransformer.s3ClientForStudentBuckets.getObject(
                  new GetObjectRequest(DataTransformer.OUTPUT_BUCKET_NAME, fileKey));
        ...
        inputFileObjects =
            DataTransformer.s3ClientForStudentBuckets.listNextBatchOfObjects(inputFileObjects);
